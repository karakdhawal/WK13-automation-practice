...
@CucumberOptions(
        features = "src/test/java/resources/featurefile", // featurefile right click copy from root content
        glue = "com/automation", // right click top java > uk.co.library then copy from source
